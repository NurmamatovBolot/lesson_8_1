...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Thor thor = new Thor("Thor", 200, 5);
        Witcher witcher = new Witcher("Witcher", 250, 0);
        Golem golem = new Golem("Golem", 500, 5);

        Hero[] heroes = {warrior, magic, doc, berserk, assistant, thor, witcher, golem};
